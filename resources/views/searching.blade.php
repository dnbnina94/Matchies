...
<div class="container">
	...
	<div class="row" id="content" style="padding-top: 3%; word-wrap: break-word;">

		<div class="col-md-3"></div>
		<div class="col-md-6" align="center" style="padding-left: 10px; padding-right: 10px">

			<div style="display: table; width: 100%; border-radius: 5px; background: rgba(170,170,170, 0.8); padding-left: 20px; padding-right: 20px; padding-top: 20px; padding-bottom:20px word-wrap: break-word; table-layout: fixed;">

				<div class="row">
					<div class="col-md-12">
						<div class="jumbotronProfile" style="word-wrap: break-word;">
						...
						<div class="jumbotronProfile" style="margin-top: 20px; color: white; font-size: 16px; font-weight: bold; word-wrap: break-word;" align="center" id="UserBio">
							<span style="word-wrap: break-word;">{{$returnUser->bio}}</span>
						</div>

						<div class="jumbotronProfile" style="margin-top: 20px; color: white; word-wrap: break-word;" align="center">
						...
						<div class="jumbotronProfile" style="margin-top: 20px; margin-bottom: 20px">
							<table width="100%">
								<tr>
									<td>

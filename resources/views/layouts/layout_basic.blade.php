  		...
  		<div id="settingsBoxCellContainer">
  			<div class="row">
  				...
  				<div class="settingsBox col-md-2" style="margin-left: 25px; margin-right: 25px">
  					...
  					<div style="padding-bottom: 10px; padding-top: 10px; border-bottom: 1px solid #B9BAB8">
                @if (!Auth::guest())
                <a href="/profile/{{Auth::user()->id}}" style="color: #AE0000">View your profile</a></div>
                @endif
  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav navbar-right">
            @if (!Auth::guest())
            <li align="center"><a href="/profile/{{Auth::user()->id}}" style="color:white; font-weight:bold;">{{ Auth::user()->username }}</a></li>
            @endif

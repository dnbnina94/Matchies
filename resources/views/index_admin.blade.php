						...
						<div class="jumbotronProfile" style="color: white; font-size: 16px; padding-bottom: 0px">
							...
							<form >
								<div class="row userRow">
									<div class="col-md-3">
										Reported user: <a href="/admin/profile/{{$report->id_source_user}}" style="font-weight: bold; color: #AE0000">{{App\User::where('id', '=', $report->id_source_user)->first()->username}}</a><br/>
									</div>
